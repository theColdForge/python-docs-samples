...
def setup() -> dict[str, str]:
    try:
        conn_vars = {"db_user": os.environ["SQLSERVER_USER"], "db_pass": os.environ["SQLSERVER_PASSWORD"], "db_name": os.environ["SQLSERVER_DATABASE"], "db_host": os.environ["SQLSERVER_HOST"], "instance_conn_name": os.environ["SQLSERVER_INSTANCE"], "db_socket_dir": os.getenv("DB_SOCKET_DIR", "/cloudsql")}
    except KeyError:
        raise Exception(
